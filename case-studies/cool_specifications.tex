...
\startsubsection[title={Goal specifications}]
  ...
  \startkaosspec
  	...
  	\KaosAttribute {Def} {Rides proposed by drivers shall be fulfilled within time constraints. By fulfilled, we mean that the driver did not travel alone.}
...
\startsubsection[title={Obstacle specifications}]
  ...
  \startkaosspec
  	...
  	\KaosAttribute {Def} {Ride offer encoded in the system does not correspond accurately to a ride proposal in the real world.}
  	\KaosAttribute {RefinedBy} {Fake Ride Offer}
  	\KaosAttribute {RefinedBy} {Ride Offer Outdated}
  	\KaosAttribute {RefinedBy} {Ride Offer Miscoded}
  \stopkaosspec

  \startkaosspec
  	\ObstacleName {Fake Ride Offer}
  	\KaosAttribute {Def} {Ride offer encoded in the system does not correspond to any ride proposal in the real world.}
  	\KaosAttribute {ESR} {0.10\%}
  \stopkaosspec

  \startkaosspec
  	\ObstacleName {Ride Offer Outdated}
  	\KaosAttribute {Def} {Ride offer is out-dated; the author of the offer did not update information yet.}
  	\KaosAttribute {ESR} {1.00\%}
  \stopkaosspec

  \startkaosspec
  	\ObstacleName {Ride Offer Miscoded}
  	\KaosAttribute {Def} {Ride offer was miscoded; some information may be missing or inaccurate.}
  	\KaosAttribute {RefinedBy} {Departure Date/Time Miscoded}
  	\KaosAttribute {RefinedBy} {Departure Point Miscoded}
  	\KaosAttribute {RefinedBy} {Arrival Date/Time Miscoded}
  	\KaosAttribute {RefinedBy} {Arrival Point Miscoded}
  \stopkaosspec

  \startkaosspec
  	\ObstacleName {Departure Date/Time Miscoded}
  ...
  \startkaosspec
  	\ObstacleName {Departure Point Miscoded}
  ...
  \startkaosspec
  	\ObstacleName {Arrival Date/Time Miscoded}
  ...
  \startkaosspec
  	\ObstacleName {Arrival Point Miscoded}
  ...
  \startkaosspec
  	...
  	\KaosAttribute {RefinedBy} {Ride Request Miscoded}
  \stopkaosspec
  ...
  \startkaosspec
  	\ObstacleName {Ride Request Miscoded}
  	\KaosAttribute {Def} {Ride request origin or destination information is miscoded.}
  	\KaosAttribute {RefinedBy} {Departure Date/Time Miscoded}
  	\KaosAttribute {RefinedBy} {Departure Point Miscoded}
  	\KaosAttribute {RefinedBy} {Arrival Date/Time Miscoded}
  	\KaosAttribute {RefinedBy} {Arrival Point Miscoded}
