  ...
  \startsection
    ...
    \startsubsection
      ...
      \startitemize
        ...
        With these combined estimates, the satisfaction rate for the parent
        obstacle is $.14 + .14 = .28$.
        
        \noindent With the {\it $1$-norm}, however, the $r$-norm satisfaction rate for
        ...
        estimate the satisfaction rate for the parent obstacle \obstacle{Power
        Supply Failure} to be $.1 \times .2 = .02$.
        
        \noindentation Using {\it $1$-norm} to combine their estimates, we
        obtain $.15$ for both subobstacles. The satisfaction rate for the
        parent obstacle is therefore $.15 \times .15 = .0225$, which differs
        from the estimate they provided independently.
        
        \noindentation Using {\it $0$-norm}, the $r$-norm satisfaction rate for
        the subobstacle is $\sqrt{.2\times .1}$. The satisfaction rate for the
  ...
  \stopsection
    ...
    \startsubsection
      ...
      \startitemize
        ...
        model is computed; this set is called the {\it obstruction superset}.
