...
\chapter
  ...
  \startsection
    ...
    \startsubsection
      ...
      We propose the following approach, inspired from \cite[OHa06a, Otw92a],
      ...
      \startitemize[n]
        ...
        models and the techniques. \cite[Vos08a,OHa06a,Otw92a] discusse in
        details how to select experts. \cite[Coo91a,Vos08a] provides a detailed
        ...
        \cite[OHa06a,Vos08a] detail techniques and pitfalls for such
    ...
    \startsubsection
      ...
      to increase the accuracy of estimates \cite[Coo91a]. The problem is then
      ...
      \cite[OHa06a, Vos08a]. More mathematical approaches are however
      ...
      r-norm} \cite[Bed01a,Coo91a]. We present here $r$-norm based combinations
      ...
      different combinations \cite[Bed01a,Coo91a]. For example, consider the
      ...
      weight for all experts. \cite[OHa06a, Bed01a, Coo91a] discuss how to
  ...
  \stopsection
    ...
    \startsubsection
      ...
      % or domain hypotheses.
        ...
        Tree \cite[Bed01a,Lam09a]. A first difference is that a cut set yields
      ...
      \stopsubsubsection
        ...
        \cite[Ebe05a,Mei12a]. Such BDDs enable fast computation of single-point
        probability values from single-point probability values for the
        variables \cite[Bed01a]. \in{Figure}[fig:bdd] shows a BDD corresponding
    ...
    \stopsubsection
      ...
      minimal \cite[Dar95a]; the subgoals there are therefore independent.
  ...
  \startsection
    ...
    \cite[Bor01a,Kun75a]. These algorithms and the specific structure of our
