...
\chapter
  ...
  likelihood of their consequences. Identifying likely and critical  risks is an
  ...
  This chapter presents how likely and critical  obstacles are identified. It
  ...
  importance of the impacted goal. Identifying likely and critical  obstacles
  amounts at finding the likely obstacle combinations that maximize that drop.
  As a result, the next resolution step might then focus on the likely and
  ...
  satisfaction rate identify likely and critical  risks.
  ...
  \startsection
    ...
    This section shows how likely and critical  risks are highligthed based on
  ...
  \startsection[title={Summary}]
    ...
    This chapter presented how likely and critical  risks are highlighted to
