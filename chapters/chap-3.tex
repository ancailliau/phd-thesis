...
\startchapter
   ...
   bookmark={A Probabilistic Framework for Goal-Oriented Requirements Engineering},
    ...
    \cite[DeL95,DeL95b,Ant98,Lev02,Lam09]. Risk management is recognized to
    decrease the number of potential defect and increase the number of remove
    defect \cite[Jon08]. The risk analysis process aims at identifying,
    ...
    \startsection
      ...
      inspired from \cite[Bai08], details and proofs can be found in that
      manuscript.
    ...
    \startsection
      ...
      operator \quote{leads to} introduced in \cite[Han94]
      ...
      Probabilistic Response \cite[Gru08]. In PCTL*, this may be formalized as:
