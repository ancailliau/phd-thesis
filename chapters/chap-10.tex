...
\chapter[chap:relatedwork]{Related Work}
  ...
  \startsection[reference=sec:comparing_cr,title={Models and Techniques for Controlling Risks}]
    ...
    or a learning-based approach \cite[Alr16a].
    ...
    handling from normal code \cite[Lip00a]. At modeling level, \cite[Ali12a]
  ...
  \startsection[reference=sec:comparing_as,title={Requirements-Driven Runtime Adaptation}]
    ...
    \noindent {\bf Context-based Approaches.} \cite[Ali09a,Ali10a] details a
    ...
    more appropriate alternative refinements. In \cite[Ali11a], a context is
    ...
    \cite[Ali11a] identifies 4 type of assumptions: {\it (a)} {\it Activation
    ...
    Contextual Goal Models} \cite[Ali09a,Ali10a]. Based on the goal refinement
    ...
    \startitemize
      ...
      terms of observed states and behaviors. Unlike \cite[Ram11a, Ali10a,
    ...
    \startitemize
      ...
      \item Unlike \cite[Mor17b,Ali09a,Ali10a,Sou13a], our approach is
