...
\define[2]\MyChapterCommand%
  {\framed[frame=off,width=\textwidth,bottomframe=on,topframe=on,boffset=1em,toffset=1em,loffset=0em,roffset=0em]
...
% define an extra for breaking pages
...
\setupcombinedlist[content][extras={3=page}]

\setupinteraction
  [state=start,
   title={Software Requirements Engineering: A Risk-Driven Approach},
   author={Antoine Cailliau},
   color=darkolivegreen,
   contrastcolor=darkolivegreen,
   style={}]
