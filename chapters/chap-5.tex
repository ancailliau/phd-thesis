...
\chapter[chap:controlling_obstacle]{Controlling Likely and Critical Obstacles}
  ...
  \stopsection
    ...
    how such selection is systematically determined.
      ...
      replaced goal. When integrated, the satisfaction rate for the top goal
...
%     \stopalign\stopformula
      ...
      satisfaction rate for the anchor goal is obtained using the satisfaction
...
%     \stopalign\stopformula
      ...
      having the lowest resolution cost such that the satisfaction rate for the
      ...
      \startitemize[n]
        ...
        rate for the high-level goals. The complexity of this naïve computation
