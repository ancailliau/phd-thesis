...
\startchapter
  ...
  system-to-be \cite[Che09c,Esf13,Let14,Wel10,Per14]. In particular, the
  ...
  \cite[OHa06a,Vos08,Per14]. For example, the chance of a sensor breaking
  ...
  experts \cite[OHa06a,Vos08,Per14]. Our imperfect knowledge of what the
  ...
  techniques proposed in the previous chapters to identify likely and critical 
  ...
  countermeasures are selected in presence of knowledge uncertainty.
    ...
    \cite[Vos08]. A probability distribution is a function assigning a
    ...
    obstacles in the system-to-be.
      ...
      might drastically change the violation uncertainty score.
    	...
    	below a threshold are taken into account \cite[Roh11]\emdash{}here, below
    	the RSR.
    ...
    \subsection{Eliciting Distributions for Leaf Obstacle Satisfaction}
      ...
      PERT, Triangular, etc. \cite[Vos08]. A quantile is a single
      ...
      satisfaction \cite[Bed01]. The 50\high{th} quantile, called mode, is the most
      likely probability of satisfaction.
   	  ...
   	  historical data in various industries \cite[Ayy14,Mil92,Cen92].
  ...
  \stopsection
    ...
    As seen in \in{Chapter}[chap:assessing], identifying likely and critical 
    obstacles is important for the next resolution step. This section shows how
    identification of likely and critical  obstacle is extended to support
    ...
    \stopitemize
      ...
      expert. This is known as calibration \cite[Bed01].
...
%        \setupTABLE[c][5][rightframe=on]
      ...
      \cite[Coo91]. This weight combines a calibration score and an
      ...
      by use of a Bayesian calibrator/estimator \cite[Men89]. It first
  ...
  \stopsection
    ...
    Previous section showed how likely and critical  obstacles are highlighted.
  ...
  \startsection[title={Summary}]
    ...
    handling uncertainties about estimated quantities \cite[Fen00]. The
