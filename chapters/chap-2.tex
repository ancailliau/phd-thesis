...
\chapter
  ...
  go wrong through obstacle analysis.
    ...
    specifications \cite[Lam09]. Among the goal-oriented frameworks, the KAOS
    framework proposes a formal approach where objectives of a system are
    defined in a precise, clear-cut sense \cite[Lam09], on the contrary of
    ...
    \subsection {Specifying Formal Assertions}
      ...
      (Metric) Linear temporal logic (LTL) \cite[Koy92,Man92] may be used for
    ...
    \subsection {Modelling Goals as AND/OR Graphs}
      ...
      or negatively to each other \cite[Gio03,Lam09]. Parent goals are
      ...
      Divide-and-Conquer} patterns \cite[Dar96,Lam09].
    ...
    \subsection{Soft Goals as Optimisation Criteria}
      ...
      designs comparison \cite[Let02,Lam09,Hea11]. Typically, soft goals are
  ...
  \stopsection
    ...
    \subsection {Specifying Formal Assertions}
      ...
      logic (LTL) \cite[Koy92,Man92]. An obstacle to
      ...
      \cite[Lam09]. An obstacle to a {\it Maintain} goal is:
    ...
    includes three steps \cite[Lam00]:
    ...
    likelihood and criticality of resolved obstacles \cite[Lam09]. The
    ...
    \cite[Lam00,Alr16]. A variety of tactics are available for exploring
    ...
    \cite[Lam00,Lam09]. For example, the obstacle mitigation tactic applied
