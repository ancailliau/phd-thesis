...
\chapter{Introduction}
  ...
  throughout the thesis is also introduced.
    ...
    \startitemize
      ...
      \item For risk control analysts may explore alternative countermeasures
  ...
  \stopsection
    ...
    \startitemize
      ...
      in the model should be preserved too.
  ...
  \stopsection
    ...
    \stopitemize    
		...
		techniques for selecting most appropriate countermeasures to the assessed
		obstacles and for integrating these countermeasures into ideal goal models.
    ...
    \stopitemize
		...
		technique for drivung system runtime adapations at runtime by the
