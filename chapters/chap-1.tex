...
\chapter{Introduction}
  ...
  throughout the thesis is also introduced.
    ...
    \noindent Building a \quote{good} model is hard. A good model shoud be:
    ...
    adequacy and completeness of the goal model. However, little
  ...
  \stopsection
    ...
    \startitemize
      ...
      in the model should be preserved by the integration process.
      ...
      supported from requirements to architecture. 
    ...
    \startitemize
      ...
      Monitoring helps determining whether probabilistic goals are currently
      satisfied, and what are the current likely and critical obstacles.
  ...
  \stopsection
    ...
    \startitemize
      ...
      \item Probabilistic goals and obstacles are introduced. Goals may be
      specified to prescribe some property to hold in $X$\% of the cases.
      Probabilistic obstacles provide more evidence-based answers to questions
      such as, e.g., what are the most critical obstacles to be resolved in
      view of higher-level, mission-critical goals?
    ...
    \stopitemize
		...
		\noindent {\bf Handling uncertainty in satisfaction rates.} The thesis
		introduces knowledge uncertainty as a first-class citizen for the {\it
		obstacle assessment} and {\it control} steps.
    
    \startitemize
    
      \item Uncertainties about obstacle estimates and goal satisfaction rates
      are explicitely captured in the specification of probabilistic goals and
      obstacles. The extended framework supports both single-point and
      multi-point value estimates.
  ...
  \stopsection
    ...
    \startitemize
      ...
      and how the satisfaction rate of higher-level goals is obtained by
      ...
      for controlling likely and critical obstacles through
      ...
      uncertainties about probabilistic values are integrated within the
      ...
      technique guarantees the required satisfation rate for high-level
      ...
      text-based declaration language used to represent goal and obstacle
      models.
